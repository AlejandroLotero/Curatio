...
export default function CreateStatusForm({ isOpen, onClose, onAdd }) {
  ...
  return (
    <>
      <Modal isOpen={isOpen} onClose={onClose} title="CREAR ESTADO">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              type="text"
              placeholder="Ej. En Revisión, Suspendido"
              name="name"
              value={formData.name}
      ...
      <Toast isVisible={showToast} message="Estado creado exitosamente" onClose={() => setShowToast(false)} />
    </>
  );
}
