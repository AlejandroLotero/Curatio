...
export default function CreateSupplierForm({ isOpen, onClose, onAdd }) {
  ...
  return (
    <>
      ...
      <Toast isVisible={showToast} message="Proveedor creado exitosamente" onClose={() => setShowToast(false)} />
    </>
  );
}
