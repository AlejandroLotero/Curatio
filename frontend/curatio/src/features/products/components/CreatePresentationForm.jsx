...
export default function CreatePresentationForm({ isOpen, onClose, onAdd }) {
  ...
  return (
    <>
      <Modal isOpen={isOpen} onClose={onClose} title="CREAR PRESENTACIÓN">
      ...
      <Toast isVisible={showToast} message="Presentación creada exitosamente" onClose={() => setShowToast(false)} />
    </>
  );
}
