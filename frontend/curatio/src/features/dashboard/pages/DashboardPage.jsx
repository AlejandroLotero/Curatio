...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-8 mt-1">
        <h1 className="text-5xl font-heading text-center mb-4">
          Bienvenido a Curatio
        </h1>
        
        <p className="text-center text-lg mb-12 font-body">
          Tu farmacia en línea personalizada
        </p>
